...
import Animation from '../../asset/escena 7.json';
import ReactHowler from "react-howler";
import sound7 from "../../asset/Sound/Audioescena7.mp3";
import moduleStyle from "../Estilos.module.css";

const Septimaescena = (Props) =>{
...
return(
  <div>
    ...
    <ReactHowler src={sound7} playing={ViewPass}/>
    </div>
